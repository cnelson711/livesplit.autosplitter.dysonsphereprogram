state("DSPGAME", "0.7.18.6940")
{
    ...
    double timef    : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x38; // secs (13.4666666)
    bool running    : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x40;
    bool loading    : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x41;
    bool paused     : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x43;
    bool isMenuDemo : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x47;
    bool ended      : "UnityPlayer.dll", 0x0150DAE8, 0x200, 0x148, 0x2a0, 0x50, 0x60, 0x00, 0x46;
