...
startup
{
    ...
    var techNames = new Dictionary<int, string>()
    {
        ...
        { 2108, "Mecha Core 1                            ,U,3600,t" },
        { 2109, "Mecha Core 2                            ,U,36000,t" },
        { 2110, "Mecha Core 3                            ,U,108000,t" },
        { 2111, "Mecha Core 4                            ,U,300000,f" },
        { 2112, "Mecha Core 5                            ,U,1440000,f" },
        { 2113, "Mecha Core ∞                            ,U,1800000,f" },
