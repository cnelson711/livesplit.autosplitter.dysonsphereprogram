state("DSPGAME", "0.7.18.7189") 
{
    // GameMain fields
    long timei      : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x30; // frame count (60 fps, ex 808)
    double timef    : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x38; // secs (13.4666666)
    bool running    : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x40;
    bool loading    : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x41;
    bool paused     : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x43;
    bool isMenuDemo : "UnityPlayer.dll", 0x01502050, 0x108, 0xB8, 0x28, 0xA0, 0x100, 0x08, 0x47;
